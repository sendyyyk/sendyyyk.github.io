...
const DisplayVideos = (props) => {
    const {componentName = "PSADRBIWf6", src = ["lost-saga.mp4"], videoTitle = "Lost Saga Wild West", description = "GK tau Gabut doang", poster = ["lost-saga.png"], date = "2 August 2024"} = props;
