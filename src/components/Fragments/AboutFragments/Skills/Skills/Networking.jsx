...
const Networking = (props) => {
    ...
    const detail = {
        hardware: [
            { src: ["computer.png", "router.png", "switch.png", "access-point.png"] },
            { name: ["Computer", "Router", "Switch", "Access Point"] },
        ],
        software: [
            { src: ["winbox.png", "putty.png", "cisco-packet-tracer.png", "virtual-box.png", "vm-ware.png"] },
            { name: ["Winbox", "Putty", "Cisco Packet Tracer", "Virtual Box", "VM Ware"] },
        ],
    };
