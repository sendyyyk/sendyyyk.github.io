...
const DisplayGallery = (props) => {
    const { src, caption, date, onClose } = props;
            ...
            {!isMobile ? (
                <div className='relative flex w-full h-full'>
                    ...
                    <div className='absolute flex w-full h-full mt-auto overflow-hidden py-1vw container-def overflow-y-auto'>
                        <div className='flex w-65vw h-45vw mx-auto my-auto'>
                            <div
                                className="relative flex h-full w-2/3 my-auto rounded-tl-1vw rounded-bl-1vw overflow-hidden"
                            ...
                            <div className={`relative flex flex-col justify-between h-full bg-white rounded-tr-1vw rounded-br-1vw xdrk-bc1-css w-25vw duration-300`}>
                                <div className={`flex flex-col w-full duration-300 h-2/5 overflow-hidden`}>
                                    <div className="relative flex w-full py-1vw">
                                        <span className="mx-auto my-auto text-1vw font-bold xdrk-c1-css">Caption</span>
                                    </div>
                                    <div className='flex flex-col w-full h-full gap-y-1vw px-1vw overflow-y-auto'>
                                        <div className='w-full h-1/6 flex justify-between'>
                                            <span className='text-0/7vw py-0/5vw px-1vw rounded-0/5vw bg-secondary text-white font-semibold'>{date}</span>
                                            <Button
                                                type="button"
                                        ...
                                        <div className='flex flex-col mx-auto h-5/6 pr-0/5vw menu-bar-scroll overflow-y-auto' style={{ width: "21.5vw" }}>
                                ...
                                <div className={`link absolute flex flex-col ${showLink ? 'w-12vw' : 'w-0'} h-5vw rounded-br-0/5vw rounded-tr-0/5vw overflow-hidden duration-300 bg-transpSecondary`} style={{ left: "23.8vw", top: "3.5vw" }}>
                                    {showButtons && (
                                        <>
                ...
                <div className='relative flex w-screen h-full overflow-y-auto'>
                    <div className='absolute flex justify-end px-5vw py-3vw w-full bg-black z-10'>
                        <span className='absolute left-1/2 translate-x-1/2min text-white text-5vw font-semibold mx-auto'>Gallery</span>
                            ...
                            <div className={`relative flex flex-col w-full gap-y-3vw duration-300`}>
                                <div className={`flex flex-col w-full duration-300`}>
                                    <div className="relative flex w-full px-3vw py-5vw">
                                        <span className="mx-auto my-auto text-5vw font-semibold text-white xdrk-c1-css">Caption</span>
                                    </div>
